 ...
 *         &lt;element name="schedule" type="{http://parsec.ru/Parsec3IntergationService}AccessSchedule" minOccurs="0"/>
...
@XmlRootElement(name = "CreateAccessSchedule")
public class CreateAccessSchedule {

    @XmlElement(required = true)
    protected String sessionID;
    protected AccessSchedule schedule;
     ...
     *     
     */
    public AccessSchedule getSchedule() {
        return schedule;
    }
     ...
     *     
     */
    public void setSchedule(AccessSchedule value) {
        this.schedule = value;
    }
